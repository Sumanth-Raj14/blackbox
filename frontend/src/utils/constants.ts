...
export const ACCENT_PRESETS = ["#ba4816", "#3b82f6", "#10b981", "#eab308"] as const;
...
export const INITIAL_APPROVALS: Record<string, ApprovalStatus> = {
